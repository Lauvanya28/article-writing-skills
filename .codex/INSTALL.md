...
Ask:
> "Do you want these skills installed globally (available everywhere) or just for this project?"

- **Global**: `~/.agents/skills/writing-skills/` (Mac/Linux) or `%USERPROFILE%\.agents\skills\writing-skills\` (Windows)
- **Project**: `.agents/skills/writing-skills/` in the current directory

## Step 2 — Download and install each skill

Fetch each file and save to `<chosen_dir>/<skill-name>/SKILL.md`:
...
Tell the user:
> "✓ 4 writing skills installed to <path>. Restart Codex to pick them up."
